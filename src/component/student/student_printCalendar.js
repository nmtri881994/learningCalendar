...
class Student_PrintCalendar extends Component {
    constructor(props) {
        super(props);
        this.state = {
            semesterYear: {},
    ...
    render() {
        var url = `${APP_URL}/api/sinhvien/calendar/print/`+this.state.studentId;
...
export  default Student_PrintCalendar